                                                    ...
                                                    <div class="dropdown show">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            ...
                                                            <a class="dropdown-item"
                                                                ...
                                                                <i style="color: #9dc8e2" class="fas fa-money-bill-alt"></i>&nbsp; &nbsp;سند قبض
                                                            </a>
                                                            <a class="dropdown-item"
                                                                href="{{route('Payment_students.show',$student->id)}}" >
                                                                <i style="color: #9dc8e2" class="fas fa-money-bill-alt"></i>&nbsp; &nbsp;سند صرف
                                                            </a>
                                                            <a class="dropdown-item"
                                                                href="{{route('ProcessingFee.show',$student->id)}}" >
                                                                <i style="color: #9dc8e2" class="fas fa-money-bill-alt"></i>&nbsp; &nbsp;استبعاد طالب
                                                            </a>    
                                                            <a class="dropdown-item"
