                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('quizzes.show', $quizze->id) }}"
                                                        class="btn btn-warning btn-sm" title="عرض الأسئلة"
                                                        role="button" aria-pressed="true"><i
                                                            class="fa fa-edit"></i></a>
                                                    <a href="{{ route('quizzes.student_exam', $quizze->id) }}"
                                                        class="btn btn-sm" style="background-color: aqua" title="الطلاب المختبرين"
                                                        role="button" aria-pressed="true"><i
                                                            class="fa fa-edit"></i></a>
