    ...
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
            ...
            <ul id="students-menu" class="collapse">
                ...
                <li>
                    ...
                    <ul id="Graduate students" class="collapse">
                        <li> <a
                                href="{{ route('Gradeauted.create') }}">{{ trans('main_trans.add_Graduate') }}</a>
                        </li>
                        <li> <a
                                href="{{ route('Gradeauted.index') }}">{{ trans('main_trans.list_Graduate') }}</a>
                        </li>
                    </ul>
                </li>
            </ul>
        ...
        <li>
            ...
            <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                ...
                <li> <a href="{{ route('Fee.index') }}">{{ trans('main_trans.list_Accounts') }}</a> </li>
                <li> <a href="{{ route('ProcessingFee.index') }}">استبعاد طالب</a> </li>
        ...
        <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#Exams-icon">
                <div class="pull-left"><i class="fas fa-book-open"></i><span
                        class="right-nav-text">الاخنبارات</span></div>
                <div class="pull-right"><i class="ti-plus"></i></div>
                <div class="clearfix"></div>
            </a>
            <ul id="Exams-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{ route('Quizze.index') }}">قائمة الاخنبارات</a> </li>
        ...
        <li>
            ...
            <ul id="library-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{ route('library.index') }}">فائمة كتب</a> </li>
            </ul>
        </li>
