...
class MyParent extends Component
{
    ...
    {
        $number=My_Parent::where('id',$id)->first();
        $images=ParentAttachment::where('parent_id',$id)->first();
        if(!empty($images)){
            Storage::disk('parent_attachments')->deleteDirectory($number->National_ID_Father);
